<?php
// Settings file for HESK 3.0.1

// ==> GENERAL

// --> General settings
$hesk_settings['site_title']='Ayuda y Soporte | Área de Clientes Monteverde LTDA';
$hesk_settings['site_url']='https://areadeclientes.monteverdeltda.com';
$hesk_settings['hesk_title']='Help Desk';
$hesk_settings['hesk_url']='https://areadeclientes.monteverdeltda.com/ayudaysoporte';
$hesk_settings['webmaster_mail']='webmaster@monteverdeltda.com';
$hesk_settings['noreply_mail']='no-reply@monteverdeltda.com';
$hesk_settings['noreply_name']='Área de Clientes Monteverde LTDA - Ayuda y Soporte';
...
'Español' => array('folder'=>'es','hr'=>'------ Responder arriba de esta linea ------'),
);

// --> Database settings
$hesk_settings['db_host']='localhost';
$hesk_settings['db_name']='admin_procrm';
$hesk_settings['db_user']='admin_mastergen';
$hesk_settings['db_pass']='6uF91b6p0S';
...
$hesk_settings['question_ask']='Solve this equation to show you are human: 8 + 9 = ';
$hesk_settings['question_ans']='16';
...
$hesk_settings['smtp_host_name']='midgard.dataservix.com';
$hesk_settings['smtp_host_port']=465;
$hesk_settings['smtp_timeout']=20;
$hesk_settings['smtp_ssl']=1;
$hesk_settings['smtp_tls']=0;
$hesk_settings['smtp_user']='official.software@monteverdeltda.com';
$hesk_settings['smtp_password']='du6ys1b3rx';
...
$hesk_settings['ticket_list']=array('trackid','lastchange','name','email','subject','status','lastreplier','time_worked');
...
#     DO NOT EDIT BELOW     #
#############################
$hesk_settings['hesk_version']='3.0.1';

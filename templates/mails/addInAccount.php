                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td bgcolor="#ffffff" width="100" align="left">
										<center>
											<a>
												<img alt="Logo" src="https://areadeclientes.monteverdeltda.com/templates/mails/images/logo-monteverde.png" width="90" height="auto" style="display: block; font-family: Helvetica, Arial, sans-serif; color: #666666; font-size: 16px;" border="0" />
											</a>
										</center>
									</td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td align="center" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">
												<p>
													Se a agregado un nueva cuenta en tu cuenta, ahora puedes encontrarla en "Mis Cuentas".
													<br><b>Ingresa y disfruta!</b>
												</p>
											</td>
                                        </tr>
                                    </table>

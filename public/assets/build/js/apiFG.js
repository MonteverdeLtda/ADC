/* apiFG v0.19.2 | (c) 2020 by FelipheGomez */
...
MV.api = {
	...
	read(urlIn=null, paramsIn=null, callback=null){
		...
		try {
			...
			console.log('error get api.',e.response);
			console.error(e);
			callback(e);
		}
	},
	create(urlIn=null, paramsIn=null, callback=null){
		...
		try {
			...
			console.log('error create api.',e.response);
			console.error(e);
	...
	update(urlIn=null, paramsIn=null, callback=null){
		...
		try {
			...
			.catch(function (e) {
				console.log('error post api.',e.response);
	...
	remove(urlIn=null, paramsIn=null, callback=null){
		urlIn = urlIn !== null ? '/records' + ((urlIn[0] !== '/') ? '/' + urlIn  : urlIn) : '/openapi';
		callback = callback !== null ? callback : function(e){};
		paramsIn = paramsIn !== null ? paramsIn : {};
		...
		try {
			...
			.catch(function (e) {
				console.log('error delete api.',e.response);
				throw new eException(e.response.code, e.response.message);
			}).finally(function(){

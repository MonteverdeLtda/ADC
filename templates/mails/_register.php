...
<html lang="en">
<head>
<title>Bienvenid@ - Estos son los datos de tu cuenta</title>
<meta charset="utf-8">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td bgcolor="#ffffff" width="100" align="left">
										<a >
											<img alt="Logo" src="//micuenta.monteverdeltda.com/templates/mails/images/logo-monteverde.png" width="52" height="78" style="display: block; font-family: Helvetica, Arial, sans-serif; color: #666666; font-size: 16px;" border="0" />
										</a>
									</td>
                                                          ...
                                                          <tr>
                                                              <td>
                                                                  <a href="#" target="_blank">
																	<img src="//micuenta.monteverdeltda.com/templates/mails/images/monteverde-operarios-600x350.png" width="500px" height="auto" border="0" alt="Can an email really be responsive?" style="display: block; padding: 0; color: #666666; text-decoration: none; font-family: Helvetica, arial, sans-serif; font-size: 16px; width: 500px; height: auto;" class="img-max" />
																</a>
                                                              </td>
                                                            </tr>
                                                        </table>

...
// apiTickets.defaults.headers.common['Authorization'] = 'Bearer ' + access_token;
// apiTickets.defaults.headers.common['Authorization'] = 'Bearer ' + access_token;

/*
apiTickets.interceptors.response.use(function (response) {
...
apiTickets.defaults.headers.common['Authorization'] = 'Bearer ' + access_token;
apiTickets.defaults.headers['X-AUTH-TOKEN'] = access_token;
*/
